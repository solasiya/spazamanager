...
import { PlusCircle, Download, Upload, AlertTriangle, ClipboardList } from "lucide-react";
      ...
      <Tabs defaultValue="all" className="mb-6">
        ...
        <TabsContent value="low-stock">
          <div className="bg-white rounded-lg shadow-sm p-5">
            <h2 className="text-xl font-heading font-bold mb-4">Low Stock Items</h2>
            <InventoryTable filterType="low-stock" />
          </div>
        </TabsContent>
        <TabsContent value="expiring">
          <div className="bg-white rounded-lg shadow-sm p-5">
            <h2 className="text-xl font-heading font-bold mb-4">Expiring Items</h2>
